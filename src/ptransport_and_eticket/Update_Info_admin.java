...
public class Update_Info_admin extends JFrame{
    private Container c;
    ...
    void initComponents()
    {
        ...
        JLabel lb1 = new JLabel("Update Activity");
        lb1.setFont(f1);
        lb1.setBounds(650, 30, 500, 100);
        pn2.add(lb1);
        
        /*btn1 = new JButton("Passenger Info");
        btn1.setFont(f2);
        ...
        btn2 = new JButton("Route Info");
        btn2.setFont(f2);
        btn2.setBounds(660, 440, 290, 60);
        btn2.setBackground(Color.darkGray);
        btn2.setForeground(Color.white);
        pn1.add(btn2);
        
        btn3 = new JButton("Bus Info");
        btn3.setFont(f2);
    ...
    {
        Update_Info_admin update = new  Update_Info_admin();
